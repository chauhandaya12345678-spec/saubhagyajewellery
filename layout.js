...
(function () {
  ...
  (function injectHead() {
    ...
    s.textContent = [
      ...
      '.logo-name{font-family:"Playfair Display",serif;font-size:22px;font-weight:600;color:#0B3C26;letter-spacing:1.5px;line-height:1}',
      ...
      '.nav-search-more{display:block;padding:12px;text-align:center;font-family:"Montserrat",sans-serif;font-size:13px;letter-spacing:1.5px;color:#0B3C26;background:#faf8f3;text-decoration:none;border-top:1px solid #eee5d6}',
